...
function getCenterZoom(departureGeo, arrivalGeo) {
    let cLat = (departureGeo.latitude + arrivalGeo.latitude) / 2;
    let cLon = (departureGeo.longitude + arrivalGeo.longitude) / 2;
